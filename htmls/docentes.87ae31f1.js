...
var _tareaJs = require("./tarea.js");
var _tareaJsDefault = parcelHelpers.interopDefault(_tareaJs);
var _materia = require("./materia");
var _materiaDefault = parcelHelpers.interopDefault(_materia);
var _materiasJs = require("./materias.js");
var _materiasJsDefault = parcelHelpers.interopDefault(_materiasJs);
var _estudiantesJs = require("./estudiantes.js");
var _estudiantesJsDefault = parcelHelpers.interopDefault(_estudiantesJs);
...
let students = (0, _estudiantesJsDefault.default);
for(i = 0; i < (0, _materiasJsDefault.default).length; i++)sub.options[i] = new Option((0, _materiasJsDefault.default)[i].nombre + ":" + (0, _materiasJsDefault.default)[i].docente, (0, _materiasJsDefault.default)[i].nombre);
crear.addEventListener("submit", (event)=>{
    event.preventDefault();
    const materia_nombre = materiadada.value;
    const docente_text = docente.value;
    let materia = new (0, _materiaDefault.default)();
    ...
    } else vistaMat.innerHTML = "<p> No se pudo crear la materia</p>";
});
createForm.addEventListener("submit", (event)=>{
    event.preventDefault();
    let tarea = new (0, _tareaJsDefault.default)();
    ...
    if (check == true) {
        ...
        listaDeTareas = "";
        for(i = 0; i < tareas.length; i++)listaDeTareas = listaDeTareas + tareas[i].getDetalles();
        divListaTareas.innerHTML = listaDeTareas;
    } else vista.innerHTML = "<p> No se creo la tarea </p>";
});
let tareaEncontrada = "";
buscarForm.addEventListener("submit", (event)=>{
    event.preventDefault();
    const search = tareaBuscada.value;
    for(let i1 = 0; i1 < tareas.length; i1++)if (tareas[i1].titulo == search) tareaEncontrada = tareaEncontrada + tareas[i1].getDetallesBrief();
...
reportBtn.addEventListener("click", (event)=>{
    ...
    for(i = 0; i < tareas.length; i++){
        for(j = 0; j < students.length; j++)if (students[j].materias.includes(tareas[i].materia)) // studentCounter++;
        tareas[i].setStudent();
    }
    //mostraamos las tareas en cada fecha
    for (const x of listaFechas.values()){
        reporteTareas = reporteTareas + x;
        for(j = 0; j < tareas.length; j++)if (tareas[j].fecha == x) {
...
},{"./tarea.js":"bEjQU","./materia":"cX7lU","./materias.js":"c7E7a","./estudiantes.js":"fdSfW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bEjQU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Tarea {
    ...
    crear(title, desc, mat, date) {
        if (title == "" || desc == "" || mat == "" || date == "") return false;
        this.titulo = title;
    ...
    getDetalles() {
        let cadenaDatos = "<p>tarea:" + this.titulo + " , " + " descripcion:" + this.descripcion + " , " + " materia:" + this.materia + " , " + " fecha:" + this.fecha + "</p>";
        return cadenaDatos;
    }
    getDetallesBrief() {
        let cadenaDatos = "<p>tarea:" + this.titulo + " , " + "materia:" + this.materia + "(" + this.estudiantes + ")" + "</p>";
        return cadenaDatos;
    }
    eliminar() {
        this.titulo = "";
...
},{}],"cX7lU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Materia {
    constructor(){
    ...
    crearMateria(siglaynombre, docente) {
        if (siglaynombre == "" || docente == "") return false;
    ...
    getDetalles() {
        let cadenaDatos = "<p> Materia:" + this.getNombre() + "<p>" + "<p> Docente:" + this.getDocente() + "<p>" + "</p>";
        return cadenaDatos;
    }
    eliminar() {
        this.nombreMateria = "";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c7E7a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/* materias precargadas */ var materias = [
    {
        nombre: "Mate Basica",
        docente: "M. Soruco"
    },
...
exports.default = materias;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fdSfW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/* estudiantes precargados */ var estudiantes = [
    {
        nombre: "Alfred Garcia",
        materias: [
            "Mate Basica:M. Soruco",
            "Algebra Lineal:A. Soruco"
        ]
    },
    {
        nombre: "Angy Encinas",
        materias: [
            "Intro a la progra:C. Sanabria",
            "Mate Basica:M. Soruco"
        ]
    },
    {
        nombre: "Rodrigo Guardia",
        materias: [
            "Algebra Lineal:A. Soruco",
            "Intro a la progra:C. Sanabria",
            "Mate Basica:M. Soruco"
...
exports.default = estudiantes;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gkoGO","jZ78i"], "jZ78i", "parcelRequirec771")

//# sourceMappingURL=docentes.87ae31f1.js.map
